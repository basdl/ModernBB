...
// Notices
'Bad request'						=>	'Der Link ist leider nicht mehr verfügbar.',
'No view'							=>	'Sie haben nicht die Berechtigung diese Foren zu sehen.',
'Bad referrer'						=>	'Sie wurden auf diese Seite von einer unbekannten Quelle verwiesen. Wenn dieses Problem weiterhin existiert stellen Sie sicher, dass \'Base URL\' in Admin/Optionen korrekt gesetzt ist und Sie dieses Forum über diese URL aufrufen. Weitere Informationen über dieses Problem finden Sie in der FluxBB Dokumentation.',
'No permission'						=>	'Sie haben keine Berechtigung diese Seite zu sehen.',
...
'Ban message 2'						=>	'Ihre Verbannung endet Ende',
...
'off'								=>	'aus',
'Invalid email'						=>	'Die eingegebenen Email ist nicht valide.',
'Required'							=>	'(Pflicht)',
'required field'					=>	'ist ein Pflichtfeld in diesem Forum.', // For javascript form validation
'Last post'							=>	'Letzter Eintrag',
'by'								=>	'von', // As in last post by some user
'New posts'							=>	'Neue Einträge', // The link that leads to the first new post
'New posts info'					=>	'Zum ersten Eintrag in diesem Thema springen.', // The popup text for new posts links
'Username'							=>	'Nutzername',
'Password'							=>	'Passwort',
'Send email'						=>	'Email senden',
'Moderated by'						=>	'Modierert von',
'Registered table'					=>	'Registriert',
'Subject'							=>	'Betreff',
'Message'							=>	'Nachricht',
'Topic'								=>	'Thema',
'Forum'								=>	'Forum',
'Posts table'						=>	'Einträge',
...
'Write message legend'				=>	'Schreiben Sie Ihre Nachrichten',
'Previous'							=>	'Vorige',
'Next'								=>	'Nächste',
...
'Posted topics'						=>	'Existierende Themen',
'Show new posts'					=>	'Finde Themen seit Ihrem letzten Besuch.',
'Show active topics'				=>	'Finde Themen mit neuen Beiträgen.',
'Show unanswered topics'			=>	'Finde Themen mit unbeantworteten Beiträgen.',
'Show posted topics'				=>	'Finde Themen bei denen Sie schon teilgenommen haben.',
'Mark all as read'					=>	'Alle als gelesen markieren',
'Mark forum read'					=>	'Als gelesen markieren',
'Title separator'					=>	' / ',
...
'Unstick topic'						=>	'Tehma abheften',
'Stick topic'						=>	'Thema anheften',
'Moderate forum'					=>	'Forum moderieren',
'Powered by'						=>	'Unterstützt von %s',
'Thanks'							=>	'Vielen Dank für das verwenden von %s',
'Version'							=>	'Version',
...
'Topic warning'			=>	'Achtung! Dies ist der erste Eintrag in diesem Thema. Das komplette Thema wird gelöscht!',
'Delete info'			=>	'The post you have chosen to delete is set out below for you to review before proceeding.',
'Reply by'				=>	'Beantwortet von %s - %s',
'Topic by'				=>	'Thema gestartet von %s - %s',
'Delete'				=>	'Löschen', // The submit button
'Post del redirect'		=>	'Beitrag gelöscht. Weiterleiten …',
'Topic del redirect'	=>	'Thema gelöscht. Weiterleiten …',
...
'Topics'		=>	'Themen',
'Link to'		=>	'Link:', // As in "Link to: http://modernbb.be/"
'Empty board'	=>	'Board ist leer.',
'Newest user'	=>	'Neueste Benutzer: %s',
'Users online'	=>	'Benutzer online: %s',
'Guests online'	=>	'Gäste online: %s',
'No of users'	=>	'Alle Benuzter: %s',
'No of topics'	=>	'Alle Themen: %s',
'No of post'	=>	'Alle Beiträge: %s',
...
'Wrong user/pass'			=>	'Flascher Nutzer und/oder Passwort.',
'Forgotten pass'			=>	'Passwort vergessen',
'Login redirect'			=>	'Erfolgreich angemeldet. Weiterleiten …',
'Logout redirect'			=>	'Erfolgreich abgemeldet. Weiterleiten …',
'No email match'			=>	'Es gibt keinen Nutzer mit dieser Email',
'Request pass'				=>	'Passwort anfordern',
'Request pass legend'		=>	'Geben Sie Ihre Email mit der Sie sich registriert haben an',
'Request pass info'			=>	'A new password together with a link to activate the new password will be sent to that address.',
'Not registered'			=>	'Registrieren',
...
'No subject'		=>	'Thema muss einen Namen habe.',
'No subject after censoring'	=>	'Topics must contain a subject. After applying censoring filters, your subject was empty.',
'Too long subject'	=>	'Zu langer Name (mehr wie 70 characters).',
'No message'		=>	'Sie müssen eine Nachricht angeben.',
'No message after censoring'	=>	'You must enter a message. After applying censoring filters, your message was empty.',
'Too long message'	=>	'Beiträge können nicht größer sein als %s bytes.',
'All caps subject'	=>	'Themen können nicht nur Großbuchstaben enthalten.',
...
'Post redirect'		=>	'Beitrag erstellt. Weiterleiten …',
'Post a reply'		=>	'Antwort erstellen',
'Post new topic'	=>	'Neues Thema erstellen',
'Hide smilies'		=>	'Never show smilies as icons for this post',
'Subscribe topic'	=>	'Dieses Thema abonnieren',
'Stay subscribed'	=>	'Dieses Thema weiterhin abonnieren',
'Topic review'		=>	'Topic  (newest first)',
...
'Localisation legend'		=>	'Ihre Einstelleungen',
'Time zone'					=>	'Zeitzone',
...
'Default'					=>	'Default',
'Language'					=>	'Sprache',
'Email setting info'		=>	'Emaileinstellungen',
'Email setting 1'			=>	'Ihre Email anzeigen.',
...
'Privacy options legend'	=>	'Privatssphäre',
...
'Section personality'			=>	'Personaleinstellungen',
'Section view' 					=>  'Profil',
'Section admin'					=>	'Administration',
'Section messaging'				=>	'Nachrichten',

// Miscellaneous
'Personal details legend'		=>	'Modify your personal and contact details',
'Settings legend'				=>	'Geben Sie Ihre Einstellungen ein',
'User activity'					=>	'Benutzerativität',
...
'Change pass legend'			=>	'Geben Sie Ihr Passwort ein und bestätigen Sie dieses.',
...
'Upload avatar'					=>	'Nutzerbild hochladen',
'Upload avatar legend'			=>	'Enter an avatar file to upload',
'Delete avatar'					=>	'Avatar löschen', // only for admins
'File'							=>	'Datei',
...
'Show topics'					=>	'Alle Themen anzeugen',
...
'Avatar'						=>	'Avatar',
'Signature'						=>	'Signature',
'Sig max size'					=>	'Maximale Länge: %s zeichen / Max. Zeilen: %s',
'Avatar legend'					=>	'Setzen Sie Ihre Avatareinstellungen',
'Avatar info'					=>	'Ein Avatar ist ein kleines Bild dass bei allen Ihren Beiträgen angezeigt wird. Sie können einen Avatar einstellen indem Sie den Link anbei klicken.',
'Change avatar'					=>	'Avatar ändern',
'Signature legend'				=>	'Erstellen Sie Ihre Signatur',
'Signature info'				=>	'Eine Signatur ist ein kleiner Text der bei jedem Ihre Beiträge angezeigt wird. Darin können Sie alles angeben was Sie wollen.',
'Sig preview'					=>	'Signaturvorscha:',
'No sig'						=>	'Es ist keine Signatur bei Ihrem Profil vorhanden.',
'Signature quote/code/list/h'	=>	'Das Zitat, Code, Listen und Überschrift BBCode ist nicht in Signaturen erlaubt.',
'Topics per page'				=>	'Themen',
'Posts per page'				=>	'Beiträge',
'Leave blank'					=>	'Lassen sie dieses Feld leer um den Forumstandard zu verwenden.',
'Subscription legend'			=>	'Setzen Sie Ihre Abonnemonteinstellungen',
'Notify full'					=>	'Eine einfache Textnachricht von neuen Beiträgen in Abonnemontemails mitschicken.',
'Auto notify full'				=>	'Automatisch jedes Thema abonnieren für welches Sie einen Beitrag verfasst haben.',
'Show smilies'					=>	'Ersetze Smilies durch Bilder.',
'Show images'					=>	'Zeige Bilder in Beiträgen.',
'Show images sigs'				=>	'Zeige Bilder in Nutzersignaturen.',
'Show avatars'					=>	'Zeige Nutzeravatar in Beiträgen.',
'Show sigs'						=>	'Zeige Nutzersignaturen.',
'Style'							=>	'Stil',
'Backstage style'				=>	'Adminstil',
'Admin note'					=>	'Admin note',
'Pagination legend'				=>	'Geben Sie Ihre Seiteneinstellungen a',
'Post display'					=>	'Beitrag anzeigen',
'Instructions'					=>	'Wenn Sie Ihr Profil bearbeiten werden Sie zurück auf diese Seite geleitet.',

// Administration stuff
'Group membership legend'		=>	'Nutzergruppe wählen',
'Save'							=>	'Speichern',
'Set mods legend'				=>	'Moderatorenzugang verwalten',
...
'Update forums'					=>	'Forum updaten',
'Delete ban legend'				=>	'Lösche oder verbanne Benutzer',
...
'Delete'						=>	'Löschen', // submit button (confirm user delete)
...
'Search'							=>	'Suche',
'Search criteria legend'			=>	'Geben Sie Ihre Suchbegriffe ein',
...
'Unsubscribe'		=>	'Abonnemont kündigen',
'Subscribe'			=>	'Dieses Thema abonnieren',
'Quick post'		=>	'Schnellbeitrag',
...
'Post topic'	=>	'Neuen Beitrag erstellen',
'Views'			=>	'Gesehen',
'Moved'			=>	'Verschoben',
'Sticky'		=>	'Sticky',
'Closed'		=>	'Geschlossen',
'Empty forum'	=>	'Dieses Forum ist leer.',
'Mod controls'	=>	'Moderator controls',
'Is subscribed'	=>	'Sie haben die Emailbenachrichtigung abonniert',
'Unsubscribe'	=>	'Emailabonnemont kündigen',
'Subscribe'		=>	'Emailbenachrichtigung für dieses Forum abonnieren',
...
// Detailed edit page
'Edit forum head'			=>	'Bearbeite Forum',
'Edit details subhead'		=>	'Bearbeite Forumsdetauls',
...
'Last post'					=>	'Neuester Beitrag',
'Topic start'				=>	'Thema erstellt',
'Subject'					=>	'Betreff',
...
'Delete group head'				=>	'Gruppe löschen',
...
'Delete posts label'			=>	'Beiträge löschen',
...
'ModernBB intro'					=>	'Willkommen bei ModernBB',
'Backup head'						=>	'Back-up',
...
'Order by last post'		=>	'Neuester Beitrag',
'Order by last visit'		=>	'Letzter Besuch',
